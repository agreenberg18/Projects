 ...
 * @author Kevin Wayne
 */
public final class StdDraw1 implements ActionListener, MouseListener,
	...
	public boolean[][] vis = { { true, true, true, true, true, true, true },
	...
	private static StdDraw1 std = new StdDraw1();
	...
	private static void init() {
		...
		frame.setTitle("Maze Game Player1");
		frame.pack();
	...
	private static Image getImage(String filename) {
		...
		if ((icon == null)
				|| (icon.getImageLoadStatus() != MediaTracker.COMPLETE)) {
			URL url = StdDraw1.class.getResource(filename);
			if (url != null)
				icon = new ImageIcon(url);
		}
	...
	public void actionPerformed(ActionEvent e) {
		FileDialog chooser = new FileDialog(StdDraw1.frame,
				"Use a .png or .jpg extension", FileDialog.SAVE);
		chooser.setVisible(true);
		String filename = chooser.getFile();
		if (filename != null) {
			StdDraw1.save(chooser.getDirectory() + File.separator
					+ chooser.getFile());
		}
	}
	...
	public void mousePressed(MouseEvent e) {
		synchronized (mouseLock) {
			mouseX = StdDraw1.userX(e.getX());
			mouseY = StdDraw1.userY(e.getY());
			mousePressed = true;
		}
	}
	...
	public void keyReleased(KeyEvent e) {
		...
		if (Flag == 'D') {
			MazeC1.mazeprogramDown();
		} else if (Flag == 'U') {
			MazeC1.mazeprogramUp();
		} else if (Flag == 'R') {
			MazeC1.mazeprogramRight();
		} else if (Flag == 'L') {
			MazeC1.mazeprogramLeft();
		}
